...
function Navbar() {
  ...
  return (
    <nav>
      <div className="px-[5%] dark:bg-zinc-900 bg-slate-50 flex flex-col gap-4 sm:flex-row sm:gap-0 justify-between items-center py-4 px-6">
