    ...
    <main className="min-h-[78vh] lg:px-[20%] px-[10%] bg-green-50 flex justify-center">
      <div className="mt-8 pb-16">
        ...
        <p className="mt-4">
          ...
          anyone decided to use our Service, the TL-DW.ai website.
        </p>
        <p className="mt-4">
        ...
        <p className="mt-4">
          ...
          Terms and Conditions, which is accessible at TL-DW.ai, unless
          otherwise defined in this Privacy Policy.
        </p>
        <p className="mt-4 text-[20px]">Information Collection and Use</p>
        <p className="mt-4">
        ...
        <p className="mt-4 text-[20px]"> Log Data</p>
        <p className="mt-4">
        ...
        <p className="mt-4 text-[20px]">Service Providers</p>
        <p className="mt-4">
          {" "}
        ...
        <p className="mt-4 text-[20px]">Security</p>{" "}
        <p className="mt-4">
        ...
        <p className="mt-4 text-[20px]">Links to Other Sites</p>{" "}
        <p className="mt-4">
        ...
        <p className="mt-4 text-[20px]">Changes to This Privacy Policy</p>{" "}
        <p className="mt-4">
        ...
        <p className="mt-4 text-[20px]">Contact Us</p>{" "}
        <p className="mt-4">
